...
with_node \
  ...
  --target "/Users/brianmasse/Developer/Software/LockPod/lockpod_mobile/ios/Pods/Target Support Files/Pods-lockpodmobile/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-barcode-scanner" "expo-camera" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake"
