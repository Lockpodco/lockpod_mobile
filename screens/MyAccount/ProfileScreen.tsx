      ...
      <View>
        ...
        <View style={styles.userDetailsContainer}>
          ...
          <UserDetails
            ...
            rightText=""
            LeftComponent={BellIcon}
            RightComponent={NotificationSwitch}
            onPress={null}
          />
          <UserDetails
            leftText="Privacy & Legal"
            rightText=""
            LeftComponent={LegalIcon}
            RightComponent={ArrowRight}
            onPress={null}
          />
        </View>
...
function NotificationSwitch() {
  ...
  return (
    <Switch
      trackColor={{
        false: Constants.secondaryDark,
        true: Constants.lightAccent,
      }}
